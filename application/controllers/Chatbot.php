...
class Chatbot extends CI_Controller {
	...
	/**
	 * Metodo POST que se encarga de solicitar al modelo un mensaje segÃºn una palabra.
	...
	public function obtieneMensaje(){
		...
		//tengo el dato anterior de lo que se respondio acÃ¡ puedo rescatar el nombre por ej si me respondiero el nombre 
